...
$(document).ready(function() {
	...
	//percent motion
	percent_89 = getCircleLoader('#percent_89');
	percent_76 = getCircleLoader('#percent_76');
...
function animatePercent(){
	...
	if (animateOnce && percent_89 && percent_76){
		percent_89.animate(0.89);
		percent_76.animate(0.76);
		animateOnce = false;
